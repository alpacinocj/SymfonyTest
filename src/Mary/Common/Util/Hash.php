...
class Hash
{
     ...
     * @return string Return an hash string
     * */
    ...
    /*
     * Validate the input password with the salt string and hash string
     * @param string $password The input password
     * @param string $salt Salt string
     * @param string $hash Hash string
     * @return boolean Return true on success, or false on fail
     * */
